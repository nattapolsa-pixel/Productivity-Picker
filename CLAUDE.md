...
| `tests/*.test.js` (12) | plain Node ไม่มี framework — `node tests/xxx.test.js` |
...
```
ไม่มี package.json / framework — plain Node (**12 ไฟล์**: 10 ไฟล์ imperative assert, 2 ไฟล์ใช้ `node:test`)
